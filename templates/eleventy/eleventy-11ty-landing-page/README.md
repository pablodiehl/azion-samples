...
The **11ty Landing Page** template helps you to build a simple landing page with 11ty and Tailwind CSS.
...
This template uses Eleventy version `0.12.1` and TailwindCSS `2.0.4`.
