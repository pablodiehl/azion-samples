...
This template uses Astro version `4.5.12` and Svelte version `4.2.5`.
...
[![Deploy Button](https://www.azion.com/button/)](https://console.azion.com/create/astro/astro-with-framework-svelte "Deploy with Azion")
