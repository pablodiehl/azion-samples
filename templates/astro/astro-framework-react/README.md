# Astro with Framework React

The **Astro with Framework React** template deploys a new edge application based on Astro working with React. Using this template, you can write your React components as .jsx or .tsx files in your project.
...
This template uses Astro version `4.5.12` and React version `18.2.0`.
...
[![Deploy Button](https://www.azion.com/button/)](https://console.azion.com/create/astro/astro-with-framework-react "Deploy with Azion")
