...
This template uses Astro version `4.5.12` and Alpine version `3.13.5`.
...
[![Deploy Button](https://www.azion.com/button/)](https://console.azion.com/create/astro/astro-with-framework-alpine "Deploy with Azion")
