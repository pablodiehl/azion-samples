...
This template uses Astro version `4.5.12` and Vue version `4.0.9`.
...
[![Deploy Button](https://www.azion.com/button/)](https://console.azion.com/create/astro/astro-with-framework-vue "Deploy with Azion")
