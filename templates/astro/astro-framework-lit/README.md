...
This template uses Astro version `4.5.12` and Lit version `3.1.2`.
...
[![Deploy Button](https://www.azion.com/button/)](https://console.azion.com/create/astro/astro-with-framework-lit "Deploy with Azion")
