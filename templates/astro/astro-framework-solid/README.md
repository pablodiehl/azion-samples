...
This template uses Astro version `4.5.12` and Solid version `1.8.5`.
...
[![Deploy Button](https://www.azion.com/button/)](https://console.azion.com/create/astro/astro-with-framework-solid "Deploy with Azion")
